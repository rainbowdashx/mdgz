...
local msgs={
		{msg="das ist tolle Arbeit Freunde" , weight=6},
		{msg="Endlich jemand, der seinen Shop versteht!", weight = 3},
		{msg="Ich dreh durch, Klasse Typ", weight=5},
		{msg="Eher nicht so schwer, {name}" , weight=5},
		{msg="Gute Arbeit bald hast du Bunter eingeholt! {name}", weight=5},
		...
		{msg="Puh.. {name}, Holla die Waldfee!",weight=5},
		{msg="{name} ich will ein Kind von dir!",weight=5},
		{msg="Hut ab! {name}",weight=20},
		{msg="Dieser {name} geht ab!",weight=10},
		{msg="Wie Charlie Sheen in Hot Shots!",weight=5},
		{msg="Sheesh, {name}!",weight=15},
		{msg="Torgo approved, {name}!",weight=5},
		{msg="The Freak gefällt das, {name}!",weight=10},
		{msg="Ich bin stolz auf dich, {name}!",weight=5},
		...
		{msg="Cool {name}, hole ich mir auch!",weight=5},
